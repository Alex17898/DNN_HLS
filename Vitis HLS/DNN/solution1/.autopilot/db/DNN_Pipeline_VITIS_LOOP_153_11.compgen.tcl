...
set name DNN_fdiv_32ns_32ns_32_7_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename temp_output \
    op interface \
    ports { temp_output_address0 { O 4 vector } temp_output_ce0 { O 1 bit } temp_output_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'temp_output'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_s_reload \
    op interface \
    ports { s_reload { I 32 vector } } \
} "
}
