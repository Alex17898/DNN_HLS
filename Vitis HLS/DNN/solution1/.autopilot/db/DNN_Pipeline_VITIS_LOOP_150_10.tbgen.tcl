set moduleName DNN_Pipeline_VITIS_LOOP_150_10
set isTopModule 0
...
set C_modelName {DNN_Pipeline_VITIS_LOOP_150_10}
set C_modelType { void 0 }
set C_modelArgList {
	{ temp_output float 32 regular {array 10 { 1 3 } 1 1 }  }
	{ s_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "temp_output", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ temp_output_address0 sc_out sc_lv 4 signal 0 } 
	{ temp_output_ce0 sc_out sc_logic 1 signal 0 } 
	{ temp_output_q0 sc_in sc_lv 32 signal 0 } 
	{ s_out sc_out sc_lv 32 signal 1 } 
	{ s_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp_output_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "temp_output", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	temp_output { ap_memory {  { temp_output_address0 mem_address 1 4 }  { temp_output_ce0 mem_ce 1 1 }  { temp_output_q0 mem_dout 0 32 } } }
