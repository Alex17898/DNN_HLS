...
// ==============================================================
#ifndef __DNN_temp_input_H__
#define __DNN_temp_input_H__
...
struct DNN_temp_input_ram : public sc_core::sc_module {
...
DNN_temp_input_ram* meminst;


SC_CTOR(DNN_temp_input) {
meminst = new DNN_temp_input_ram("DNN_temp_input_ram");
