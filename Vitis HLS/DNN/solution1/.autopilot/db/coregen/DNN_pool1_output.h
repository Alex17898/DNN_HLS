...
// ==============================================================
#ifndef __DNN_pool1_output_H__
#define __DNN_pool1_output_H__
...
struct DNN_pool1_output_ram : public sc_core::sc_module {
...
DNN_pool1_output_ram* meminst;


SC_CTOR(DNN_pool1_output) {
meminst = new DNN_pool1_output_ram("DNN_pool1_output_ram");
