set moduleName DNN_Pipeline_VITIS_LOOP_158_12
set isTopModule 0
...
set C_modelName {DNN_Pipeline_VITIS_LOOP_158_12}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r float 32 regular {array 10 { 1 3 } 1 1 }  }
	{ max_idx_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "max_idx_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_idx_out sc_out sc_lv 32 signal 1 } 
	{ max_idx_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_idx_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_idx_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 4 }  { output_r_ce0 mem_ce 1 1 }  { output_r_q0 mem_dout 0 32 } } }
	max_idx_out { ap_vld {  { max_idx_out out_data 1 32 }  { max_idx_out_ap_vld out_vld 1 1 } } }
}
