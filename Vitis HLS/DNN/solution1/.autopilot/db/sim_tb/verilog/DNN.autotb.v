...
`define AUTOTB_DUT      DNN
`define AUTOTB_DUT_INST AESL_inst_DNN
`define AUTOTB_TOP      apatb_DNN_top
`define AUTOTB_LAT_RESULT_FILE "DNN.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "DNN.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_DNN_top
...
`define AUTOTB_TVIN_input_r  "./c.DNN.autotvin_input_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.DNN.autotvin_input_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.DNN.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.DNN.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 753;
parameter LENGTH_input_r = 100;
...
wire    [6 : 0]    arrayinput_r_address0, arrayinput_r_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.DNN.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.DNN.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.DNN.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.DNN.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.DNN.autotvout_ap_return.dat with impl_rtl.DNN.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
