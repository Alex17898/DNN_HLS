set moduleName DNN_Pipeline_VITIS_LOOP_153_11
set isTopModule 0
...
set portList { 
	...
	{ s_reload sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s_reload", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_7_no_dsp_1_U264", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	s_reload { ap_none {  { s_reload in_data 0 32 } } }
