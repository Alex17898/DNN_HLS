...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DNN.autotvin.dat"
	set constFileTvOut       "DNN.autotvout.dat"
	set constFileHdlTvIn     "DNN.autohdltvin.dat"
	set constFileHdlTvOut    "DNN.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
