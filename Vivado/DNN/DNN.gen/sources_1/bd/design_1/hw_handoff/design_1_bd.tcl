...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led_ctrl1_0 [ create_bd_port -dir O led_ctrl1_0 ]
  set led_ctrl2_0 [ create_bd_port -dir O led_ctrl2_0 ]
  set led_ctrl3_0 [ create_bd_port -dir O led_ctrl3_0 ]
  set led_ctrl4_0 [ create_bd_port -dir O led_ctrl4_0 ]

  # Create instance: DNN_0, and set properties
  set DNN_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:DNN:1.0 DNN_0 ]
...
0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned}\
  ...
  connect_bd_net -net DNN_0_ap_done [get_bd_pins DNN_0/ap_done] [get_bd_pins nn_ctrl_0/ap_done]
  connect_bd_net -net DNN_0_ap_idle [get_bd_pins DNN_0/ap_idle] [get_bd_pins nn_ctrl_0/ap_idle]
  connect_bd_net -net DNN_0_ap_ready [get_bd_pins DNN_0/ap_ready] [get_bd_pins nn_ctrl_0/ap_ready]
  connect_bd_net -net DNN_0_ap_return [get_bd_pins DNN_0/ap_return] [get_bd_pins nn_ctrl_0/nn_res_in]
  connect_bd_net -net DNN_0_input_r_address0 [get_bd_pins DNN_0/input_r_address0] [get_bd_pins fix_address_0/addr_in]
  connect_bd_net -net DNN_0_input_r_ce0 [get_bd_pins DNN_0/input_r_ce0] [get_bd_pins axi_bram_ctrl_0_bram/enb]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins DNN_0/input_r_q0] [get_bd_pins axi_bram_ctrl_0_bram/doutb]
  ...
  connect_bd_net -net fix_address_0_addr_out [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins fix_address_0/addr_out]
  connect_bd_net -net nn_ctrl_0_ap_rst [get_bd_pins nn_ctrl_0/ap_rst] [get_bd_pins not_gate_0/i_in]
  connect_bd_net -net nn_ctrl_0_ap_start [get_bd_pins DNN_0/ap_start] [get_bd_pins nn_ctrl_0/ap_start]
  connect_bd_net -net nn_ctrl_0_led_ctrl1 [get_bd_ports led_ctrl1_0] [get_bd_pins nn_ctrl_0/led_ctrl1]
  connect_bd_net -net nn_ctrl_0_led_ctrl2 [get_bd_ports led_ctrl2_0] [get_bd_pins nn_ctrl_0/led_ctrl2]
  connect_bd_net -net nn_ctrl_0_led_ctrl3 [get_bd_ports led_ctrl3_0] [get_bd_pins nn_ctrl_0/led_ctrl3]
  connect_bd_net -net nn_ctrl_0_led_ctrl4 [get_bd_ports led_ctrl4_0] [get_bd_pins nn_ctrl_0/led_ctrl4]
  connect_bd_net -net not_gate_0_o_out [get_bd_pins DNN_0/ap_rst] [get_bd_pins not_gate_0/o_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DNN_0/ap_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_smc/aclk] [get_bd_pins nn_ctrl_0/i_Clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
