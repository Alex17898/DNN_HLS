...
HD_PWD='D:/hls/C++/test/Vivado/DNN/DNN.runs/design_1_fix_address_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fix_address_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fix_address_0_0.tcl
